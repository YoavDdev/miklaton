              ...
              >
                ...
                <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2 sm:gap-3">
                  <button
                    ...
                    className="px-3 sm:px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 active:scale-95 font-medium flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm"
                  >
                  ...
                  <button
                    ...
                    className="px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 active:scale-95 font-medium flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm"
                  >
                    🔗 <span className="hidden sm:inline">העתק </span>לינק
                  </button>

                  <button
                    onClick={() => loadResponses(survey)}
                    className="px-3 sm:px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 active:scale-95 font-medium flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm"
                  >
                  ...
                  {survey.status === 'active' ? (
                    <button
                      ...
                      className="px-3 sm:px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 active:scale-95 font-medium text-xs sm:text-sm"
                    >
                      🔒 סגור<span className="hidden sm:inline"> סקר</span>
                    </button>
                  ) : (
                    <button
                      onClick={() => reopenSurvey(survey.id)}
                      className="px-3 sm:px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 active:scale-95 font-medium text-xs sm:text-sm"
                    >
                      🔓 פתח<span className="hidden sm:inline"> מחדש</span>
                    </button>
                  )}
                </div>
              </div>
