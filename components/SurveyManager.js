  ...
  return (
    <div className="bg-white rounded-lg shadow">
      <div className="p-6 border-b border-gray-200 flex justify-between items-center">
        <div>
          <h2 className="text-xl font-bold text-gray-900">📊 סקרי שביעות רצון</h2>
          <p className="text-sm text-gray-600 mt-1">צור סקרים ושלח למטפלים דרך WhatsApp</p>
        </div>
        <button
      ...
      <div className="p-6">
        {surveys.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">אין סקרים עדיין</p>
            <button
              onClick={() => setShowCreateModal(true)}
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {survey.closed_at && (
                        <span className="mr-4">• נסגר: {new Date(survey.closed_at).toLocaleDateString('he-IL')}</span>
                      )}
                      <span className="mr-4 font-bold text-blue-600">• {survey.response_count} תשובות</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-lg font-bold text-gray-900">📊 סקר חדש</h3>
              <button
                onClick={() => {
                  setShowCreateModal(false);
                  setNewSurveyTitle('');
