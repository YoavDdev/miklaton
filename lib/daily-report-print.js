import { buildReportLayout } from '@/lib/daily-report-excel';
...
<style>
  * { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
  body { font-family: Arial, 'Segoe UI', sans-serif; margin: 24px; color: #000; }
  table { width: 100%; border-collapse: collapse; table-layout: fixed; }
  col.c1 { width: 26%; } col.c2 { width: 34%; } col.c3 { width: 20%; }
  col.c4 { width: 10%; } col.c5 { width: 10%; }
